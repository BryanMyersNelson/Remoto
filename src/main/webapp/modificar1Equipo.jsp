...
entidades.add("Ligas");
entidades.add("Jugadores");
entidades.add("Equipos");
%>
</head>
			...
			<div id="content">
				...
				<form action="operaciones.jsp?tipo=modificarEquipo" method="post">
					...
					<div class="row gtr-50">
						<div class="">
							<select id="modificarEquipo" name="modificarEquipo" maxlength="3">
								<%
								for (Equipo equipos : controladorBD.todosEquipos()) {
								%>
								<option value="<%=equipos.getCod_equipo()%>"><%=equipos.getNombre()%></option>
								<%
								}
								%>
							</select>
					...
					<div style="padding-top: 22px;">
						<ul class="actions">
							<li><input type="submit" class="button alt"
								value="Modificar🤓☝️🦧🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐🐐 THE G.O.A.T" /></li>
						</ul>
					</div>
				</form>
