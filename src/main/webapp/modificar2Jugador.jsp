	...
	<div id="page-wrapper">
		...
		<div class="container">
			<div id="content">
				...
				<form action="operaciones.jsp?tipo=modificacionJugador" method="post">
					<div class="row gtr-50">
					<img src="images/jugadores/<%=jugador.getCod_jugador()%>.png"
						width="200x" height="200px">
						<div class="">
							<input type="text" name="nombre" id="nombre" placeholder="Nombre del jugador"
								value="<%=jugador.getNombre()%>" style="width: 450px"
								; maxlength="20" required />
						</div>
						<div class="">
							<input type="text" name="pierna" id="pierna"
								placeholder="Pierna buena del jugador" value="<%=jugador.getPierna()%>" maxlength="9" required />
						</div>
						<div class="">
								<select id="cod_equipo" name="cod_equipo" maxlength="3">
						
							<%
							for (Equipo equipo : controladorBD.todosEquipos()) {
							%>
							<option value="<%=equipo.getCod_equipo()%>"><%=equipo.getNombre()%></option>
							<%
							}
							%>
														</select>
						...
						<div class="">
							<input type="text" name="pais" id="pais"
								placeholder="Pais del jugador" maxlength="20" required  value="<%=jugador.getPais()%>" />
						</div>
						<div class="">
							<input type="number" name="altura" id="altura"
								placeholder="Altura del jugador" maxlength="4"  required value="<%=jugador.getAltura()%>" />
						</div>
						
						<div class="">
							<input type="number" name="cod" id="cod"
								placeholder="Codigo del jugador" maxlength="4" min="0" required value="<%=jugador.getCod_jugador()%>" />
						</div>
