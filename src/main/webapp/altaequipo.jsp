					...
					<div class="row gtr-50">
						<div class="">
							<input type="text" name="nombre" id="nombre"
								placeholder="Nombre del Equipo" style="width: 450px"
								maxlength="20" required />
						</div>
						<div class="">
							<select id="cod_liga" name="cod_liga" maxlength="3">
								<%
								
								for (Liga liga : controladorBD.todasLigas()) {
								%>
								<option value="<%=liga.getCod_jugador()%>"><%=liga.getNombre()%></option>
								<%
								}
								%>
							</select>
