							...
							<!-- Content -->
								...
								<form action="operaciones.jsp?tipo=AltaEquipo" method="post">
									<div class="row gtr-50">
										<div class="">
											<input type="text" name="nombre" id="nombre" placeholder="Nombre del Equipo" style="width:450px" maxlength="20" required/>
										</div>
										<div class="">
											<input type="number" name="cod_liga" id="cod_liga" placeholder="Código de liga" maxlength="9" required/>
										</div>
										<div class="">
											<input type="number" name="cod_equipo" id="cod_equipo" placeholder="Código del equipo" maxlength="3" required/>
										</div>
