					...
					<div class="row gtr-50">
						...
						<div class="">
							<input type="text" name="pierna" id="pierna"
								placeholder="Pierna buena del jugador" maxlength="9" required />
						</div>
						<div class="">
						...
						<div class="">
							<input type="text" name="pais" id="pais"
								placeholder="Pais del jugador" maxlength="20" required />
						</div>
						<div class="">
							<input type="number" name="altura" id="altura"
								placeholder="Altura del jugador" maxlength="4" min="0" required />
						</div>
